...
# mlf2spaceflights documentation build
...
from mlf2spaceflights import __version__ as release

# -- Project information -----------------------------------------------------

project = "mlf2spaceflights"
author = "Kedro"
...
htmlhelp_basename = "mlf2spaceflightsdoc"
...
latex_documents = [
    (
        master_doc,
        "mlf2spaceflights.tex",
        "mlf2spaceflights Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "mlf2spaceflights",
        "Project mlf2spaceflights codebase.",
        "Data-Science",
    )
]
